	...
	<div class="row">
		...
		<div class="col-md-6">
			<div class="pull-right text-white">
		        ...
		        <span style="color:#6c757d;">	{{ __('business.already_registered')}}</span> <a href="{{ action('Auth\LoginController@login') }}@if(!empty(request()->lang)){{'?lang=' . request()->lang}} @endif" style="color:#6c757d;">{{ __('business.sign_in') }}</a>
		        @endif
	        </div>
		</div>
	</div>
