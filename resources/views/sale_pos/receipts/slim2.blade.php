...
<html lang="en">
    ...
    <body>
        <div class="ticket">
			...
			<div class="flex-box">
				<p class="width-50 text-left">
					<strong>{{$receipt_details->total_tender_label}}</strong>
				</p>
				<p class="width-50 text-right">
					<strong>{{$receipt_details->total_tender_value}}</strong>
				</p>
			</div>

			@if($receipt_details->change_due_unformatted > 0)
			<div class="flex-box">
				<p class="width-50 text-left">
					<strong>{{$receipt_details->change_due_label}}</strong>
				</p>
				<p class="width-50 text-right">
					<strong>{{$receipt_details->change_due_value}}</strong>
				</p>
			</div>
			@endif
