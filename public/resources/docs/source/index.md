...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"location_id":11,"final_total":37798925.268407635,"transaction_date":"2020-5-7 15:20:22","tax_rate_id":7,"expense_for":8,"contact_id":9,"additional_notes":"non","is_refund":0,"is_recurring":0,"recur_interval":4,"recur_interval_type":"months","subscription_repeat_on":15,"subscription_no":"aut","recur_repetitions":17,"payment":[{"amount":453.13,"method":"cash","account_id":11,"card_number":"et","card_holder_name":"sed","card_transaction_number":"voluptatem","card_type":"consectetur","card_month":"nihil","card_year":"dolor","card_security":"omnis","transaction_no_1":"sit","transaction_no_2":"ullam","transaction_no_3":"tempore","note":"impedit","cheque_number":"incidunt"}]}'
...
let body = {
    "location_id": 11,
    "final_total": 37798925.268407635,
    ...
    "payment": [
        {
            ...
            "card_type": "consectetur",
            "card_month": "nihil",
            "card_year": "dolor",
            "card_security": "omnis",
            "transaction_no_1": "sit",
            "transaction_no_2": "ullam",
            "transaction_no_3": "tempore",
            "note": "impedit",
            "cheque_number": "incidunt"
        }
    ]
}
...
```bash
curl -X GET \
    -G "https://posdemo.revealpos.cloud/connector/api/expense/59" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://posdemo.revealpos.cloud/connector/api/expense/59"
);
...
```bash
curl -X PUT \
    "https://posdemo.revealpos.cloud/connector/api/expense/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"final_total":91828359.04,"transaction_date":"2020-5-7 15:20:22","tax_rate_id":9,"expense_for":4,"contact_id":15,"additional_notes":"illum","is_recurring":0,"recur_interval":1,"recur_interval_type":"months","subscription_repeat_on":15,"subscription_no":"rerum","recur_repetitions":12,"payment":[]}'
...
let body = {
    "final_total": 91828359.04,
    "transaction_date": "2020-5-7 15:20:22",
    "tax_rate_id": 9,
    "expense_for": 4,
    "contact_id": 15,
    "additional_notes": "illum",
    "is_recurring": 0,
    "recur_interval": 1,
    "recur_interval_type": "months",
    "subscription_repeat_on": 15,
...
```bash
curl -X GET \
    -G "https://posdemo.revealpos.cloud/connector/api/expense-refund?location_id=iure&payment_status=paid&start_date=2018-06-25&end_date=2018-06-25&expense_for=et&per_page=15" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://posdemo.revealpos.cloud/connector/api/expense-refund"
);
...
```bash
curl -X GET \
    -G "https://posdemo.revealpos.cloud/connector/api/product?brand_id=reiciendis&category_id=aliquam&sub_category_id=necessitatibus&location_id=eum&selling_price_group=autem&name=eligendi&sku=quaerat&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://posdemo.revealpos.cloud/connector/api/product"
);
...
```bash
curl -X GET \
    -G "https://posdemo.revealpos.cloud/connector/api/product/1?selling_price_group=iste" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://posdemo.revealpos.cloud/connector/api/product/1"
);

let params = {
    "selling_price_group": "iste",
};
Object.keys(params)
    .forEach(key => url.searchParams.append(key, params[key]));
...
```bash
curl -X GET \
    -G "https://posdemo.revealpos.cloud/connector/api/selling-price-group" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://posdemo.revealpos.cloud/connector/api/selling-price-group"
);
...
```bash
curl -X GET \
    -G "https://posdemo.revealpos.cloud/connector/api/variation/?brand_id=omnis&category_id=repellendus&sub_category_id=laboriosam&not_for_selling=in&name=ea&sku=vero&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://posdemo.revealpos.cloud/connector/api/variation/"
);

let params = {
    "brand_id": "omnis",
    "category_id": "repellendus",
...
```bash
curl -X GET \
    -G "https://posdemo.revealpos.cloud/connector/api/sell?location_id=vero&contact_id=sit&payment_status=paid&start_date=2018-06-25&end_date=2018-06-25&user_id=qui&service_staff_id=tenetur&shipping_status=ordered&only_subscriptions=consectetur&order_by_date=desc&per_page=10" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://posdemo.revealpos.cloud/connector/api/sell"
);
...
let params = {
    ...
    "end_date": "2018-06-25",
    "user_id": "qui",
    "service_staff_id": "tenetur",
    "shipping_status": "ordered",
    "only_subscriptions": "consectetur",
    "order_by_date": "desc",
    "per_page": "10",
};
Object.keys(params)
...
curl -X POST \
    ...
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"sells":[{"location_id":2,"contact_id":20,"transaction_date":"2020-07-22 15:48:29","invoice_no":"excepturi","status":"final","sub_status":"null","is_quotation":true,"tax_rate_id":20,"discount_amount":10,"discount_type":"fixed","sale_note":"illum","staff_note":"veritatis","commission_agent":17,"shipping_details":"Express Delivery","shipping_address":"quia","shipping_status":"ordered","delivered_to":"'Mr robin'","shipping_charges":10,"packing_charge":10,"exchange_rate":1,"selling_price_group_id":8,"pay_term_number":3,"pay_term_type":"months","is_suspend":false,"is_recurring":0,"recur_interval":19,"recur_interval_type":"months","subscription_repeat_on":15,"subscription_no":"earum","recur_repetitions":11,"rp_redeemed":6,"rp_redeemed_amount":13.5,"types_of_service_id":19,"service_custom_field_1":"ut","service_custom_field_2":"enim","service_custom_field_3":"et","service_custom_field_4":"hic","service_custom_field_5":"dignissimos","service_custom_field_6":"ipsa","round_off_amount":2021.51,"table_id":15,"service_staff_id":3,"change_return":0,"products":[{"product_id":17,"variation_id":58,"quantity":1,"unit_price":437.5,"tax_rate_id":0,"discount_amount":0,"discount_type":"percentage","sub_unit_id":10,"note":"quidem"}],"payments":[{"amount":453.13,"method":"cash","account_id":3,"card_number":"provident","card_holder_name":"repellendus","card_transaction_number":"eius","card_type":"veniam","card_month":"mollitia","card_year":"atque","card_security":"itaque","transaction_no_1":"placeat","transaction_no_2":"eius","transaction_no_3":"quam","bank_account_number":"esse","note":"libero","cheque_number":"dolore"}]}]}'
    ...
    "sells": [
        {
            ...
            "recur_interval_type": "months",
            "subscription_repeat_on": 15,
            "subscription_no": "earum",
            "recur_repetitions": 11,
            "rp_redeemed": 6,
            "rp_redeemed_amount": 13.5,
            "types_of_service_id": 19,
            "service_custom_field_1": "ut",
            "service_custom_field_2": "enim",
            "service_custom_field_3": "et",
            "service_custom_field_4": "hic",
            "service_custom_field_5": "dignissimos",
            "service_custom_field_6": "ipsa",
            "round_off_amount": 2021.51,
            "table_id": 15,
            "service_staff_id": 3,
            "change_return": 0,
            "products": [
            ...
            "payments": [
                {
                    ...
                    "card_month": "mollitia",
                    "card_year": "atque",
                    "card_security": "itaque",
                    "transaction_no_1": "placeat",
                    "transaction_no_2": "eius",
                    "transaction_no_3": "quam",
                    "bank_account_number": "esse",
                    "note": "libero",
...
```bash
curl -X GET \
    -G "https://posdemo.revealpos.cloud/connector/api/sell/55" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://posdemo.revealpos.cloud/connector/api/sell/55"
);
...
```bash
curl -X PUT \
    "https://posdemo.revealpos.cloud/connector/api/sell/6" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"contact_id":15,"transaction_date":"2020-5-7 15:20:22","status":"final","sub_status":"null","is_quotation":true,"tax_rate_id":19,"discount_amount":10,"discount_type":"fixed","sale_note":"ut","staff_note":"minus","sells":[{"is_suspend":false}],"commission_agent":14,"shipping_details":"Express Delivery","shipping_address":"rerum","shipping_status":"ordered","delivered_to":"Mr Robin","shipping_charges":10,"packing_charge":10,"exchange_rate":1,"selling_price_group_id":15,"pay_term_number":3,"pay_term_type":"months","is_recurring":0,"recur_interval":18,"recur_interval_type":"days","subscription_repeat_on":7,"subscription_no":"itaque","recur_repetitions":7,"rp_redeemed":12,"rp_redeemed_amount":13.5,"types_of_service_id":20,"service_custom_field_1":"doloribus","service_custom_field_2":"id","service_custom_field_3":"est","service_custom_field_4":"asperiores","service_custom_field_5":"quos","service_custom_field_6":"est","round_off_amount":19420489.4762,"table_id":2,"service_staff_id":3,"change_return":0,"change_return_id":18,"products":[{"sell_line_id":8,"product_id":17,"variation_id":58,"quantity":1,"unit_price":437.5,"tax_rate_id":20,"discount_amount":0,"discount_type":"percentage","sub_unit_id":4,"note":"id"}],"payments":[{"payment_id":6,"amount":453.13,"method":"cash","account_id":1,"card_number":"maiores","card_holder_name":"occaecati","card_transaction_number":"voluptatem","card_type":"quod","card_month":"qui","card_year":"aut","card_security":"tenetur","transaction_no_1":"est","transaction_no_2":"beatae","transaction_no_3":"voluptatibus","note":"alias","cheque_number":"error","bank_account_number":"velit"}]}'
...
let body = {
    ...
    "subscription_no": "itaque",
    "recur_repetitions": 7,
    "rp_redeemed": 12,
    "rp_redeemed_amount": 13.5,
    "types_of_service_id": 20,
    "service_custom_field_1": "doloribus",
    "service_custom_field_2": "id",
    "service_custom_field_3": "est",
    "service_custom_field_4": "asperiores",
    "service_custom_field_5": "quos",
    "service_custom_field_6": "est",
    "round_off_amount": 19420489.4762,
    "table_id": 2,
    "service_staff_id": 3,
    "change_return": 0,
    "change_return_id": 18,
    ...
    "payments": [
        {
            ...
            "account_id": 1,
            "card_number": "maiores",
            "card_holder_name": "occaecati",
            "card_transaction_number": "voluptatem",
            "card_type": "quod",
            "card_month": "qui",
            "card_year": "aut",
            "card_security": "tenetur",
            "transaction_no_1": "est",
            "transaction_no_2": "beatae",
            "transaction_no_3": "voluptatibus",
            "note": "alias",
            "cheque_number": "error",
...
```bash
curl -X DELETE \
    "https://posdemo.revealpos.cloud/connector/api/sell/cumque" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```bash
curl -X POST \
    "https://posdemo.revealpos.cloud/connector/api/sell-return" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"transaction_id":19,"transaction_date":"2020-5-7 15:20:22","invoice_no":"quis","discount_amount":10,"discount_type":"fixed","products":[{"sell_line_id":14,"quantity":1,"unit_price_inc_tax":437.5}]}'
...
```bash
curl -X GET \
    -G "https://posdemo.revealpos.cloud/connector/api/list-sell-return" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://posdemo.revealpos.cloud/connector/api/list-sell-return"
);
...
```bash
curl -X POST \
    "https://posdemo.revealpos.cloud/connector/api/update-shipping-status" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"id":5,"shipping_status":"ordered","delivered_to":"voluptas"}'
...
```bash
curl -X GET \
    -G "https://posdemo.revealpos.cloud/connector/api/active-subscription" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://posdemo.revealpos.cloud/connector/api/active-subscription"
);
...
```bash
curl -X GET \
    -G "https://posdemo.revealpos.cloud/connector/api/packages" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://posdemo.revealpos.cloud/connector/api/packages"
);
...
```bash
curl -X GET \
    -G "https://posdemo.revealpos.cloud/connector/api/table?location_id=eveniet" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://posdemo.revealpos.cloud/connector/api/table"
);
...
```bash
curl -X GET \
    -G "https://posdemo.revealpos.cloud/connector/api/table/5" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://posdemo.revealpos.cloud/connector/api/table/5"
);
...
```bash
curl -X GET \
    -G "https://posdemo.revealpos.cloud/connector/api/tax" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://posdemo.revealpos.cloud/connector/api/tax"
);
...
```bash
curl -X GET \
    -G "https://posdemo.revealpos.cloud/connector/api/tax/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://posdemo.revealpos.cloud/connector/api/tax/1"
);
...
```bash
curl -X GET \
    -G "https://posdemo.revealpos.cloud/connector/api/taxonomy?type=ratione" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://posdemo.revealpos.cloud/connector/api/taxonomy"
);
...
```bash
curl -X GET \
    -G "https://posdemo.revealpos.cloud/connector/api/taxonomy/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://posdemo.revealpos.cloud/connector/api/taxonomy/1"
);
...
```bash
curl -X GET \
    -G "https://posdemo.revealpos.cloud/connector/api/types-of-service" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://posdemo.revealpos.cloud/connector/api/types-of-service"
);
...
```bash
curl -X GET \
    -G "https://posdemo.revealpos.cloud/connector/api/types-of-service/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://posdemo.revealpos.cloud/connector/api/types-of-service/1"
);
...
```bash
curl -X GET \
    -G "https://posdemo.revealpos.cloud/connector/api/unit" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://posdemo.revealpos.cloud/connector/api/unit"
);
...
```bash
curl -X GET \
    -G "https://posdemo.revealpos.cloud/connector/api/unit/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://posdemo.revealpos.cloud/connector/api/unit/1"
);
...
```bash
curl -X GET \
    -G "https://posdemo.revealpos.cloud/connector/api/user/loggedin" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://posdemo.revealpos.cloud/connector/api/user/loggedin"
);
...
```bash
curl -X GET \
    -G "https://posdemo.revealpos.cloud/connector/api/user?service_staff=nisi" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://posdemo.revealpos.cloud/connector/api/user"
);
...
```bash
curl -X GET \
    -G "https://posdemo.revealpos.cloud/connector/api/user/1" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://posdemo.revealpos.cloud/connector/api/user/1"
);
...
```bash
curl -X POST \
    "https://posdemo.revealpos.cloud/connector/api/update-password" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}" \
    -d '{"current_password":"veritatis","new_password":"excepturi"}'
...
```bash
curl -X GET \
    -G "https://posdemo.revealpos.cloud/connector/api/payment-accounts" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://posdemo.revealpos.cloud/connector/api/payment-accounts"
);
...
```bash
curl -X GET \
    -G "https://posdemo.revealpos.cloud/connector/api/payment-methods" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://posdemo.revealpos.cloud/connector/api/payment-methods"
);
...
```bash
curl -X GET \
    -G "https://posdemo.revealpos.cloud/connector/api/business-details" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://posdemo.revealpos.cloud/connector/api/business-details"
);
...
```bash
curl -X GET \
    -G "https://posdemo.revealpos.cloud/connector/api/profit-loss-report?location_id=saepe&start_date=2018-06-25&end_date=2018-06-25&user_id=dolorem" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://posdemo.revealpos.cloud/connector/api/profit-loss-report"
);
...
```bash
curl -X GET \
    -G "https://posdemo.revealpos.cloud/connector/api/product-stock-report" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://posdemo.revealpos.cloud/connector/api/product-stock-report"
);
...
```bash
curl -X GET \
    -G "https://posdemo.revealpos.cloud/connector/api/notifications" \
    -H "Content-Type: application/json" \
    -H "Accept: application/json" \
    -H "Authorization: Bearer {token}"
```
...
```javascript
const url = new URL(
    "https://posdemo.revealpos.cloud/connector/api/notifications"
);
